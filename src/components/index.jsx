      ...
      <div className="surface-0 flex justify-content-center">
        <div id="home" className="landing-wrapper overflow-hidden">
          <div
            ...
            style={{
              background:
                "radial-gradient(circle, rgba(0,165,79,0.44861694677871145) 17%, rgba(227,0,0,0.39539565826330536) 100%)",

              clipPath: "ellipse(150% 87% at 93% 13%)",
            }}
          >
            <div className="mx-4 md:mx-8 mt-0 md:mt-4 flex align-items-center">
              <img
                src="/images/Logo.png"
              ...
              <div className="text-center ml-4 md:ml-8">
                <h1 className="text-6xl font-bold text-gray-900 line-height-2">
                  Tecnimezclas
                  <span className="font-light block">y los mil colores</span>
                </h1>
                <p className="font-normal text-2xl line-height-3 md:mt-3 text-gray-700">
                  En Tecnimezclas, no solo encontrarás una amplia gama de
                  productos de ferretería de la más alta calidad, sino que
                  también te invitamos a descubrir el mundo de los colores.
                  Somos más que una ferretería; somos una fuente de inspiración
                  para tus proyectos, ya sea que estés construyendo, renovando o
                  buscando dar vida a tus ideas creativas.
                </p>
              </div>
            </div>

            <div className="flex justify-content-center md:justify-content-end"></div>
          </div>
            ...
            <div className="grid my-8 pt-2 md:pt-8">
              <div className="col-12 lg:col-6 my-auto flex flex-column text-center lg:text-left lg:align-items-start">
                ...
                >
                  ...
                  pulvinar mattis nunc sed blandit libero. Suspendisse in est
                  ante in. Mauris pharetra et ultrices neque ornare aenean
